...
<div id="completionMessage" style="display: none;">
  <h2>Congratulations! You have completed the challenge.</h2>
  <img src="images/congrats1_4x-790197745.png" alt="Completion Image">
  <div class="share-buttons">
    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://thelocalhost.blog/ForensicsWorkstation/phish1?text=https%3A%2F%2F35000usdperwwekpodf.blogspot.sg%3Fp%3D9swghttps%3A%2F%2F35000usdperwwekpodf.blogspot.co.il%3Fo%3D0hnd" target="_blank" class="linkedin-button">Share on LinkedIn</a>
...
<script>
  function shareOnLinkedIn() {
    var url = "https://www.linkedin.com/sharing/share-offsite/?url=https://thelocalhost.blog/ForensicsWorkstation/phish1?text=https%3A%2F%2F35000usdperwwekpodf.blogspot.sg%3Fp%3D9swghttps%3A%2F%2F35000usdperwwekpodf.blogspot.co.il%3Fo%3D0hnd";
    var params = {
      url: "your_share_url_here",
      mini: true,
      title: "Completed lab on Investigating Phishing Emails!",
      summary: "Investigating Phishing: Emails
      Topics:
        - Email Header Analysis [Gmail] ( Sandbox Environment — (static & dynamic analysis)
        - ⁠Email Header Analysis: SPF, DKIM, DMARC, SCL & BCL score? 
        - What is SPF, DKIM, DMARC?⁠( supported actions without proper authentication , none, quarantine , reject)
        - ⁠Breaking Down an Email: such as (X-priority , Content-Type , From and Received-SPF , etc… )
      ...
      source: "thelocalhost.blog",
      // Add the predefined image URL
      // Here's an example:
      image: "images/file-26212286-jpg.jpg"
    };
