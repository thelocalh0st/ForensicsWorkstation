...
<div class="task">
  <h2>Task 1: Introduction to Networking</h2>
  <div class="question">
    <p>What does TCP stand for?</p>
    <input type="text" id="answer1">
    <button onclick="checkAnswer('answer1', 'TCP')">Submit</button>
    <span id="result1"></span>
  </div>
  <div class="question">
    <p>What is the default port for HTTP?</p>
    <input type="text" id="answer2">
    <button onclick="checkAnswer('answer2', '80')">Submit</button>
...
<script>
  ...
  var userAnswer = document.getElementById(inputId).value.trim();
  var resultSpan = document.getElementById(inputId.replace('answer', 'result'));
  
  if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
    resultSpan.textContent = 'Correct';
    resultSpan.classList.add('task-complete');
  } else {
