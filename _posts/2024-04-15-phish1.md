...
<form onsubmit="verifyAnswer4(); return false;">
  <label for="answer">4] What is the URL found inside the attachment? </label>
  <label class="search-label">
    <input type="text" name="text" class="input" id="answer4" required="true">
  </label>
  <button type="submit">
    <div class="svg-wrapper-1">
      <div class="svg-wrapper">
...
<script>
  function verifyAnswer4() {
    var userAnswer4 = document.getElementById("answer4").value;
    var correctAnswer4 = "https://35000usdperwwekpodf.blogspot.sg?p=9swghttps://35000usdperwwekpodf.blogspot.co.il?o=0hnd";
    var resultDisplay4 = document.getElementById("verificationResult4");
...
<div id="completionMessage" style="display: none;">
  ...
  <img src="path_to_your_image/image.jpg" alt="Completion Image">
