...
tags: [memoryforensics, lab6, The Reckoning]
---


<br>
<div class="eleven">
  <h1 style="color:cyan;">Lab 6 - The Reckoning </h1>
</div> 
<br>
...
Challenge file: <a href="https://mega.nz/#!C0pjUKxI!LnedePAfsJvFgD-Uaa4-f1Tu0kl5bFDzW6Mn2Ng6pnM">Google drive</a>

<br>
<iframe style="display: block; margin: auto;" width="560" height="315" src="https://www.youtube.com/embed/KZDNwlA2Rm4?si=tsByjtrAxr9n6Vie" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
<br>
...
<form onsubmit="verifyAnswer2(); return false;">
  <label for="answer2">2] What wa the password of RAR file?  </label>
<label class="search-label">
...
<script>
  function verifyAnswer2() {
    ...
    var correctAnswer = "easypeasyvirus";
...
<form onsubmit="verifyAnswer3(); return false;">
  <label for="answer3">3] Enter the suspicious URL You found while scrolling through History Dump ? </label>
<label class="search-label">
    <input type="text" name="text" class="input" id="answer3" required="" placeholder="*****://********.***/********">
    <kbd class="slash-icon">/</kbd>
    <svg class="search-icon" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 56.966 56.966" style="enable-background:new 0 0 512 512" xml:space="preserve">
      <g>
        <path d="M55.146 51.887 41.588 37.786A22.926 22.926 0 0 0 46.984 23c0-12.682-10.318-23-23-23s-23 10.318-23 23 10.318 23 23 23c4.761 0 9.298-1.436 13.177-4.162l13.661 14.208c.571.593 1.339.92 2.162.92.779 0 1.518-.297 2.079-.837a3.004 3.004 0 0 0 .083-4.242zM23.984 6c9.374 0 17 7.626 17 17s-7.626 17-17 17-17-7.626-17-17 7.626-17 17-17z" fill="currentColor" data-original="#000000" class=""></path>
...
<script>
  function verifyAnswer3() {
    ...
    var correctAnswer = "https://pastebin.com/RSGSi1hk";
...
<form onsubmit="verifyAnswer4(); return false;">
  <label for="answer4">4] Enter the mega drive Key </label>
<label class="search-label">
...
<script>
  function verifyAnswer4() {
    ...
    var correctAnswer = "zyWxCjCYYSEMA-hZe552qWVXiPwa5TecODbjnsscMIU";
...
<form onsubmit="verifyAnswer5(); return false;">
  <label for="answer5">5] Enter the final flag </label>
 <label class="search-label">
...
<script>
  function verifyAnswer5() {
    ...
    var correctAnswer = "inctf{thi5cH4LL3Ng3!s_g0nn4b3?aN_Am4zINg!i_gU3Ss???}";
    var resultDisplay = document.getElementById("verificationResult5");

    if (userAnswer === correctAnswer) {
      resultDisplay.textContent = "Congratulations! You have completed this challenge.";
      resultDisplay.style.color = "green";
    } else {
      resultDisplay.textContent = "Incorrect. Please try again.";
      resultDisplay.style.color = "red";
