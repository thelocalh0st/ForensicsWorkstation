...
<br>
<div class="eleven">
  <h1 style="color:cyan;">Lab 0 - Never Too Late Mister!</h1>
</div>
...
Challenge file: <a href="https://drive.google.com/file/d/1MjMGRiPzweCOdikO3DTaVfbdBK5kyynT/view">Google drive</a>


<br>
<iframe style="display: block; margin: auto;" width="560" height="315" src="https://www.youtube.com/embed/Ng0J4sVKB1k?si=tweqGwDq5xaLwJeI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
<br>
...
<form onsubmit="verifyAnswer2(); return false;">
  <label for="answer">2] Enter the PID of cmd.exe, Dumpit.exe respectively after exploring the processes running ! ex: (PID1,PID2) </label>
  <label class="search-label">
...
<form onsubmit="verifyAnswer3(); return false;">
  <label for="answer">3] What was the command executed to run the python file </label>
  <label class="search-label">
...
<script>
  function verifyAnswer3() {
    ...
    var correctAnswer3 = "C:\\Python27\\python.exe C:\\Users\\hello\\Desktop\\demon.py.txt";
...
<form onsubmit="verifyAnswer4(); return false;">
  <label for="answer">4] Enter the password hash of hello user </label>
  <label class="search-label">
...
<script>
  function verifyAnswer4() {
    ...
    var correctAnswer4 = "101da33f44e92c27835e64322d72e8b7";
...
<form onsubmit="verifyAnswer5(); return false;">
  <label for="answer">5] Enter the final flag </label>
  <label class="search-label">
...
<script>
  function verifyAnswer5() {
    ...
    var correctAnswer5 = "flag{you_are_good_but1_4m_b3tt3r}";
