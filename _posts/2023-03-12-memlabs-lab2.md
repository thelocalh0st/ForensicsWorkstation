...
tags: [memoryforensics, lab2, A New World]
---


<br>
<div class="eleven">
  <h1 style="color:cyan;">Lab 2 - A New World! </h1>
</div>
<br>
...
Challenge file: <a href="https://mega.nz/#!ChoDHaja!1XvuQd49c7-7kgJvPXIEAst-NXi8L3ggwienE1uoZTk">Google drive</a>

<br>
<iframe style="display: block; margin:auto;" width="560" height="315" src="https://www.youtube.com/embed/oaJCatpcqBc?si=0A2v4ZMhb1AX5sgp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
<br>
...
<form onsubmit="verifyAnswer2(); return false;">
  <label for="answer2">2] Enter the process running on PID 3008 </label>
  <label class="search-label">
...
<form onsubmit="verifyAnswer3(); return false;">
  <label for="answer3">3] Enter the first stage flag (Hint: NEW_TMP) </label>
  <label class="search-label">
...
<script>
  function verifyAnswer3() {
    ...
    var correctAnswer = "flag{w3lc0m3_T0_$T4g3_!_Of_L4B_2}";
...
<form onsubmit="verifyAnswer4(); return false;">
  <label for="answer4">4] What is the password of the database in KeePass </label>
  <label class="search-label">
...
<form onsubmit="verifyAnswer5(); return false;">
  <label for="answer5">5] Enter the 2nd Stage flag </label>
  <label class="search-label">
...
<script>
  function verifyAnswer5() {
    ...
    var correctAnswer = "flag{w0w_th1s_1s_Th3SeC0nD_ST4g3!!}";
...
<form onsubmit="verifyAnswer6(); return false;">
  <label for="answer6">6] $ echo -n flag{w3ll_3rd_stage_was_easy} | sha1sum </label>
  <label class="search-label">
...
<script>
  function verifyAnswer6() {
    ...
    var correctAnswer = "6045dd90029719a039fd2d2ebcca718439dd100a";
...
<form onsubmit="verifyAnswer7(); return false;">
  <label for="answer7">7] Enter the final Flag </label>
  <label class="search-label">
...
<script>
  function verifyAnswer7() {
    ...
    var correctAnswer = "flag{oK_So_Now_St4g3_3_is_DoNE!!}";
